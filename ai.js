...
function combineGenes(par1, par2) {
  ...
  var width = Math.sqrt(randomBetween(Math.min(ai[par1][5] * ai[par1][6] / 3, ai[par2][5] * ai[par2][6] / 3), Math.max(ai[par1][5] * ai[par1][6] / 3, ai[par2][5] * ai[par2][6] / 3)));
  var height = width;
